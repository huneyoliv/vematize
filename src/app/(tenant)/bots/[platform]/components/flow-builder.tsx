...
export function FlowBuilder({ initialData, products, tenantId }: FlowBuilderProps) {
...
function FlowContent({ flowIndex, products, tenantId, onRemoveFlow }: { flowIndex: number; products: Product[]; tenantId: string; onRemoveFlow: () => void; }) {
...
function StepCard({ flowIndex, stepIndex, removeStep, products, tenantId, allSteps, isStartStep, setAsStartStep }: { flowIndex: number, stepIndex: number, removeStep: (index: number) => void, products: Product[], tenantId: string, allSteps: z.infer<typeof BotStepSchema>[], isStartStep: boolean, setAsStartStep: () => void }) {
        ...
        <Card className="bg-background/40">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="flex justify-end">
                    <VariablesHelper tenantId={tenantId} />
                </div>
                <Separator />
                <div>
