...
import { Plus, Trash2, Star, ChevronDown, ChevronUp, Save } from 'lucide-react';
...
export default function FlowBuilder({ flows, onChange, onSave, products, saving }: FlowBuilderProps) {
  ...
  const toggleStep = (stepId: string) => {
    setExpandedSteps({ ...expandedSteps, [stepId]: !expandedSteps[stepId] });
  };
