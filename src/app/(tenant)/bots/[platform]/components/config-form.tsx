...
function GenericConnectionManager() {
    ...
    const handleTestConnection = async () => {
        ...
        try {
            // Testa a conexão com o Discord API através da nossa API route (evita CORS)
            ...
            if (result.success) {
                ...
                toast({
                    ...
                    description: result.message || 'Verifique se o token está correto.',
                });
            }
        } catch (error) {
            ...
            setTestResult({
                success: false,
                message: 'Erro ao conectar com o Discord. Verifique sua conexão.',
            });
            toast({
                variant: "destructive",
                title: "Erro",
                description: "Erro ao testar conexão. Tente novamente.",
            });
        } finally {
            setIsTesting(false);
        }
