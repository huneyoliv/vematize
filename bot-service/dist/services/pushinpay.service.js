...
exports.createPushinPayPixPayment = createPushinPayPixPayment;
exports.createPushinPayCheckout = createPushinPayCheckout;
const env_1 = require("../config/env");
/**
 * Cria um pagamento PIX via PushinPay
 */
async function createPushinPayPixPayment(tenant, product, saleId, buyerId, finalPriceOverride) {
    try {
 ...
 */
async function createPushinPayCheckout(tenant, product, saleId, buyerId, finalPriceOverride) {
    try {
        const ppSettings = tenant.paymentIntegrations?.pushinpay;
        if (!ppSettings) {
            return { success: false, message: 'O vendedor não configurou o PushinPay.' };
